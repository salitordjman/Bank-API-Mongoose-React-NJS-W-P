...
//   expect(0).toBe(userOneDetails.credit);
//   const userTwoDetails = await userDetails.findById(userTwoId);
//   expect(0).toBe(userTwoDetails.cash);
// });
...
// test("Fail- Not Enough Money- withdraw userTwo", async () => {
//   await request(app)
//     .patch(`/api/users/withdraw/${userTwoId}`)
//     .send({
//       withdraw: 2000,
...
// test("Fail- Not Enough Money-Should transferring from userTwo to userOne", async () => {
//   await request(app)
//     .patch(`/api/users/transferring/${userTwoId}`)
//     .send({
//       transferring: 3000,
